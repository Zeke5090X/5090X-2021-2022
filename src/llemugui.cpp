...
void llemugui(){
    if(page == 0){
        ...
        pros::lcd::print(1, "tank 1 act = %d", tank1act);
        pros::lcd::print(2, "tank 2 act = %d", tank2act);
        pros::lcd::print(3,"");
        pros::lcd::print(4,"");
        pros::lcd::print(5,"");
        pros::lcd::print(6,"");
        ...
        pros::lcd::print(6, "4 bar temp %d", fbar.get_temperature());
        pros::lcd::print(7, "lift temp %d", lift.get_temperature());
    }else if(page == 2){
        pros::lcd::print(0,"");
        pros::lcd::print(1,"");
        pros::lcd::print(2,"");
